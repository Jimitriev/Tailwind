 ...
 const Deposit: FC = function () {
    return(
        <div className="container">
            <div className='w-full border-b-2 border-dark-500 flex items-center justify-between py-10 max-lg:flex-col'>
                ...
                <div className='w-1/2 flex flex-col justify-center items-center rounded-lg bg-[#64618742] max-lg:w-full'>
                    <div className='w-full flex flex-col px-10 py-10'>    
                        ...
                        <div className='flex items-center bg-blue-900 rounded-lg'>
                            <div className='w-full flex items-center justify-between ml-2'>
                                ...
                                <button className='rounded-r-lg text-white h-[60px] bg-primary text-textDarkPrimary' >Copy</button>
                            </div>
                        </div>
                    </div>
                </div>
